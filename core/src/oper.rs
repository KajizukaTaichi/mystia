...
impl Node for Oper {
    ...
    fn compile(&self, ctx: &mut Compiler) -> Option<String> {
        Some(match self {
            ...
            Oper::Div(lhs, rhs) => compile_arithmetic!("div", self, ctx, lhs, rhs),
            Oper::Mod(lhs, rhs) => compile_arithmetic!("rem", self, ctx, lhs, rhs),
            Oper::Eql(lhs, rhs) => compile_arithmetic!("eq", self, ctx, lhs, rhs),
            Oper::Neq(lhs, rhs) => compile_arithmetic!("ne", self, ctx, lhs, rhs),
            Oper::Lt(lhs, rhs) => compile_arithmetic!("lt", self, ctx, lhs, rhs),
            Oper::Gt(lhs, rhs) => compile_arithmetic!("gt", self, ctx, lhs, rhs),
            Oper::LtEq(lhs, rhs) => compile_arithmetic!("le", self, ctx, lhs, rhs),
            Oper::GtEq(lhs, rhs) => compile_arithmetic!("ge", self, ctx, lhs, rhs),
            Oper::Cast(lhs, rhs) => {
                format!(
                    "({}.{} {})",
                    rhs.compile(ctx)?,
