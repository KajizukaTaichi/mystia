...
export class OSLib {
    constructor() {
        this.functions = {
            ...
            rename: (src,dest) => {return fs.renameSync(read(this.instance, "str", src),read(this.instance, "str", dest));},
            chdir: (value) => {return write(this.instance, "str", process.chdir(read(this.instance, "str", value)));},
            listdir: (value) => {return write(this.instance, "str", fs.readdirSync(read(this.instance, "str", value)));},
            path_join: (value, end) => {return write(this.instance, "str", path.join(read(this.instance, "str", value),read(this.instance, "str", end)));},
            path_basename: (value) => {return write(this.instance, "str", path.basename(read(this.instance, "str", value)));},
            path_parent: (value) => {return write(this.instance, "str", path.dirname(read(this.instance, "str", value)));},
            path_abs: (value) => {return write(this.instance, "str", path.resolve(read(this.instance, "str", value)));},
            path_exist: (value) => {return fs.existsSync(read(this.instance,"str",value));},
            path_isfile: (value) => {
                let isFile = false;
                try {
                isFile = fs.statSync(read(this.instance,"str",value)).isFile();
                } catch {
                isFile = false;
                }
                return isFile;
            ...
            path_isdir: (value) => {
                let isDir = false;
                try {
                isDir = fs.statSync(read(this.instance,"str",value)).isDirectory();
                } catch {
                isDir = false;
                }
                return isDir;
            },
            path_isabs: (value) => {return path.isAbsolute(read(this.instance,"str",value));},
            //path_split: (value) => Math.exp(value),
            path_root: (value) => {return write(this.instance, "str", path.parse(read(this.instance, "str", value)).root);},
            // path_match: (p,s) => {
            ...
            //     return results;
            // },
            path_ext: (value) => {return write(this.instance, "str", path.extname(read(this.instance, "str", value)));},
        };
    }
    set_wasm(instance) {
